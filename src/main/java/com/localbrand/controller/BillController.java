...
public class BillController {
    ...
    @GetMapping(Interface_API.API.Bill.BILL_GET_ALL_LIST_PRODUCT_BILL_USER)
    public ResponseEntity<ServiceResult<List<BillProductResponseDTO>>> getAllListProductBill(
            @RequestParam Optional<Integer> page,
            @RequestParam Optional<Integer> limit,
