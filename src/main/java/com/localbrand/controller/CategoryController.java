...
public class CategoryController {
    ...
    public ResponseEntity<ServiceResult<List<CategoryParentDTO>>> fillAllCategoryParentByPropertiesAndSort(@RequestParam Optional<Integer> sort, @RequestParam Optional<Integer> idStatus,@RequestParam Optional<Integer> page) {
