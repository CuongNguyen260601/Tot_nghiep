...
public class ComboDetailServiceImpl implements ComboDetailService {
    ...
    public ComboDetailServiceImpl(@Lazy ComboDetailRepository comboDetailRepository, ComboDetailMapping comboDetailMapping) {
    ...
    @Override
    public ServiceResult<List<ComboDetailResponseDTO>> findByIdCombo(Integer idCombo, Optional<Integer> page) {
